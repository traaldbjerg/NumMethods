...
stats 'mat/residual_evolution.dat' using 2 nooutput
y_min = STATS_min
y_max = STATS_max

set title "Evolution of the residual of the flexible preconditioned conjugate gradient method, w-cycle as preconditioner, m = 2817"
...
set ylabel "Residual"
plot "mat/residual_evolution.dat" with lines
replot
replot